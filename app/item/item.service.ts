...
export class ItemService {
    ...
    private aug = new Array<Item>(
        ...
        { id: 4, month:7, name: "Field Day", type: "Event", date: "08/08" },
    ...
    private oct = new Array<Item>(
        { id: 1,  month:9, name: "Bulldog Bash", type: "Event", date: "10/01"},
        { id: 2,  month:9, name: "Lip Sync Competition", type: "Event", date: "10/02"},
        { id: 3,  month:9, name: "Silent Disco", type:"Event", date:"10/02"},
        { id: 4,  month:9, name: "Stop & Serve", type: "Event", date: "10/03"},
        { id: 5,  month:9, name: "National Taco Day", type: "Event", date: "10/04"},
        { id: 6,  month:9, name: "Comedy Show", type:"Event", date:"10/05"},
        { id: 7,  month:9, name: "Parade", type: "Event", date: "10/05"},
        { id: 8,  month:9, name: "Homecoming Carnival", type: "Event", date: "10/05"},
        { id: 9,  month:9, name: "Georgia vs Vanderbelt", type:"Game", date:"10/06"},
        { id: 10, month:9, name: "Drag Queen Bingo", type: "Event", date: "10/09"},
        { id: 11, month:9, name: "Dance the Night Away", type: "Event", date: "10/11"},
        { id: 12, month:9, name:"Dawgs Making it Better", type:"Event", date:"10/12"},
        { id: 13, month:9, name: "Georgia vs LSU", type: "Game", date: "10/13"},
        { id: 14, month:9, name: "The Rocky Horror Picture Show", type: "Preformance", date: "10/18"},
        { id: 15, month:9, name: "The Rocky Horror Picture Show", type: "Preformance", date: "10/19"},
        { id: 16, month:9, name: "The Rocky Horror Picture Show", type: "Preformance", date: "10/20"},
        { id: 17, month:9, name: "The Rocky Horror Picture Show", type: "Preformance", date: "10/21"},
        { id: 15, month:9, name: "Karaoke Night", type:"Event", date:"10/23"},
        { id: 16, month:9, name: "Fall Break", type:"Holiday", date:"10/26"},
        { id: 17, month:9, name: "Georgia vs Florida", type: "Game", date: "10/027"},
        { id: 18, month:9, name: "Murder Mystery", type: "Event", date: "10/30"},
    );
    private nov = new Array<Item>(
        { id: 1,  month:10, name: "Wild N Out", type: "Event", date: "11/01" },
        { id: 2,  month:10, name: "Casino Night", type: "Event", date: "11/02" },
        { id: 3,  month:10, name: "Georgia vs Kentucky", type: "Game", date: "11/03" },
        { id: 4,  month:10, name: "National Donut Day", type: "Event", date: "11/05" },
        { id: 5,  month:10, name: "Ramsey Palooza", type: "Event", date: "11/08" },
        { id: 6,  month:10, name: "Georgia vs Auburn", type: "Game", date: "11/10" },
        { id: 7,  month:10, name: "Oxfam Hunger Banquet", type: "Event", date: "11/13" },
        { id: 8,  month:10, name: "Georgia vs Massachusetts", type: "Game", date: "11/17" },
        { id: 9,  month:10, name: "Thanksgiving Break", type: "Holiday", date: "11/19 - 11/23" },
        { id: 10, month:10, name: "Georgia vs Georgia Tech", type: "Game", date: "11/24" },
        { id: 11, month:10, name: "National Cotton Candy Day", type: "Event", date: "11/26" },
        { id: 12, month:10, name: "Disney Singalong", type: "Event", date: "11/28" },
        { id: 13, month:10, name: "Late Night Bingo", type: "Event", date: "11/29" }, 
    );
    private dec = new Array<Item>(
        { id: 1, month:11, name: "Last Day of Class", type: "Event", date: "12/04" },
        { id: 2, month:11, name: "Reading Day", type: "Event", date: "12/05" },
        { id: 3, month:11, name: "Finals", type: "Event", date: "12/06" },
        { id: 4, month:11, name: "Finals", type: "Event", date: "12/07" },
        { id: 5, month:11, name: "Finals", type: "Event", date: "12/10" },
        { id: 6, month:11, name: "Finals", type: "Event", date: "12/11" },
        { id: 7, month:11, name: "Finals", type: "Event", date: "12/12" },
        { id: 8, month:11, name: "Commencement", type: "Event", date: "12/14" },
    );
